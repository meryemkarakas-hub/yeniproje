                                ...
                                <?php
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        echo '<div class="row">' .
                                                ...
                                                '<div class="col-xs-4"><a href="basvuranlariGor.php?id=' .$row["ilanid"] .'"><button style=" background-color: #1CB94E" type="button" class="form-control btn btn-ilanlar">Görüntüle</button></a></div>' .
                                                '</div>';
										}
									}
