        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-login">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="login-form" action="registerback.php" method="GET" role="form" style="display: block;">
								...
								<div class="form-group">
                                    <input type="text" name="bolum" id="bolum" tabindex="6" autocomplete="off" class="form-control" placeholder="Bölümü"  aria-required="true"  required/>
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="date" name="dtarihi" id="dtarihi" tabindex="8" autocomplete="off" class="form-control"  placeholder="Doğum Tarihi" aria-required="true" required/>
                                </div>
                                <div class="form-group">
                                    <input type="radio" name="cinsiyet" value="kadın" aria-required="true"  required/><label>kadın</label>
