                                ...
                                <?php
                                    if (mysqli_num_rows($result) > 0) {
										...
										while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo '<div class="row">' .
                                                    '<div class="col-xs-7" style =" margin-top: 7px;  ">' . $row["SirketlerAd"] . '</div>' .
                                                   '<div class="col-xs-3"><a href="ilanGoster.php?id='. $row["idSirketler"]. '"><button style="color:white" type="button" class="form-control btn btn-ilanlar"> İlanlar </button></a></div>' .
                                                    '</div>' 
													;
                                        }
                                    }
